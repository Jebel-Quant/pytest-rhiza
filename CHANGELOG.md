...
- *(pyproject)* Accept a version derived from the VCS

### 🐛 Bug Fixes

- Keep uv.lock's own version in step with the manifest
- Drop the non-existent --no-locked flag from the weekly job
